...
{
    internal sealed class TrackingDimensions
    {
        private static bool done = false;
        private static Vehicle[] vics;

        //TODO: dont dupe
        public static void CreateTrackingObject(string parent, Vector3 pos, Vector3 scale)
        {
